 ...
 *
 */
if([220200,"dialog_gang_hqlist"] call life_fnc_gang_activedialog) exitWith {hint localize "STR_aapps_gang_dialog_inuse"};
...
"];
_btn ctrlSetEventhandler ["ButtonClick","0 spawn life_fnc_gang_selecthq"]; //maybe there's a guimessage
