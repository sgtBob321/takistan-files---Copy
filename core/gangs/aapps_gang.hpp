...
class gang_config {
	...
	temp_gang_price = 15000; //Price for temporary gangs
    perm_gang_price = 150000; //Initial price for permanent gangs

	default_bank_cash = 15000; //Default balance for permanent gangs after creation
	default_temp_maxmembers = 4; //Default maxmembers for temporary gangs after creation

	max_tax_rate = 40; //Max tax rate in %
	remove_hq_upgrades = false; //Remove bought hq upgrades on a HQ switch
	...
	class hqupgrades { //max 5 classes
		class atm {
			...
			price = 200000;
			action = "closedialog 0; 0 spawn life_fnc_atmMenu"; //spawn -> v4.0 fix
		};
		class market {
		...
		/*
		class locker { //you need to remove at least one of this hqugprades to use the locker
			displayName = "$STR_locker";
			price = 900000;
			action = "closeDialog 0; ""GANG"" spawn life_fnc_locker_db_sync";
		};
		*/
	};

	class defaultpermission {
		temp[] = {{0,"Owner",{"INVITE","KICK","WITHDRAW","DEPOSIT","DISBAND","TOPERM","CHANGEPERMISSION"}},{1,"Member",{"DEPOSIT"}}};
		perm[] = {{0,"Owner",{"INVITE","KICK","HQ","DEPOSIT","PAYTAX","HQSPAWN","RANKS","WITHDRAW","DESCRIPTION","TAX","DISBAND","UPGRADE","CHANGEPERMISSION","TAG"}},{1,"Member",{"HQSPAWN","PAYTAX","DEPOSIT"}}};
	};
...
class life_gang_overview {
	...
	class controls {
		class RscText_1003: Life_RscStructuredText //Description
		{
			idc = 220050;
			text = "";
			x = 0.304062 * safezoneW + safezoneX;
...
class life_gang_atm {
    ...
    class controlsBackground {
		...
		class RscText_1008: Life_RscText //Wrapper
		{
			idc = -1;
	...
	class controls {
		...
		class RscStructuredText_1100: Life_RscText //Balance
		{
			idc = 220122;
			text = "";
			x = 0.422656 * safezoneW + safezoneX;
		...
		class RscStructuredText_1102: Life_RscText //own
		{
			idc = 220124;
			text = "";
			x = 0.422656 * safezoneW + safezoneX;
...
class life_gang_grouppermission {
	...
	class controls {
		...
		class RscButton_1603: Life_RscButton //Rechtsoben
		{
			idc = 220168;
