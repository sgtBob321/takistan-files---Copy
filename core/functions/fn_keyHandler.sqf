...
switch (_code) do {
	...
	if (_alt && _code isEqualTo 62 && isNil "alt_f4") then {
		hint "This function is prohibited!";
		cutText ["Function prohibited!", "BLACK FADED"];
    ...
    case 22: {
        if (!_alt && !_ctrlKey) then {
            ...
            if (_veh isKindOf "House_EP1" && {playerSide isEqualTo civilian}) then {
