...
while{true} do
{
   ...
   _rip = false;
	...
	if!(alive _robber) exitWith {};
[0,format["Police News: A store has just been robbed: the stolen amount of money was $%3!",name _robber, _shop, [_kassa] call life_fnc_numberText]] remoteExec ["life_fnc_broadcast",west];
[0,format["Police News: A store has just been robbed: the stolen amount of money was $%3! if you have seen the robbers, contact police!",name _robber, _shop, [_kassa] call life_fnc_numberText]] remoteExec ["life_fnc_broadcast",civilian];
