...
/*
    ...
    Blah blah.
*/
private _takistanArray = ["Land_House_K_2_basehide_EP1","Land_House_K_2_basehide_EP1"];
private _tanoaArray = ["Land_School_01_F","Land_Warehouse_03_F","Land_House_Small_02_F"];
private _hideoutObjs = [[["Takistan", _takistanArray], ["Tanoa", _tanoaArray]]] call TON_fnc_terrainSort;
