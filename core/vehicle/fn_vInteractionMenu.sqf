...
#define Btn8 37457
#define Title 37401
private ["_display","_curTarget","_Btn1","_Btn2","_Btn3","_Btn4","_Btn5","_Btn6","_Btn7", "_Btn8", "_id"];
if (!dialog) then {
...
if (playerSide isEqualTo west) then {
	...
	_Btn8 buttonSetAction "[cursorTarget] spawn life_fnc_gpsTracker; closeDialog 0;";
	if ((life_inv_gpstracker >= 1) && {alive life_vInact_curTarget}) then {_Btn8 ctrlEnable true; _Btn8 ctrlSetTooltip "Attach A GPS Tracker";} else {_Btn8 ctrlEnable false;};
