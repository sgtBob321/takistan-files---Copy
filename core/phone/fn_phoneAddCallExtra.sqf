...
*/
private["_player", "_number", "_index", "_ringCounter", "_phoneNumbers"];
...
_leftText ctrlSetStructuredText parseText format["<t align='center' size='0.6'>%1<br/>Accept</t>", getText(missionConfigFile >> "CfgPhone" >> "phone_keyCodeAcceptName")];
...
[true, _player, player, _index] remoteExec ["ton_fnc_phoneManagerExtra", 2];
