...
if(_txt != '') then {
	...
	{ _newGear pushBack _x; _totalCost = _totalCost + 25;} forEach _uniformItemsNew; //25 per item
	{ _newGear pushBack _x; _totalCost = _totalCost + 25;} forEach _vestItemsNew; //25 per item
	{ _newGear pushBack _x; _totalCost = _totalCost + 25;} forEach _backpackItemsNew; //25 per item
