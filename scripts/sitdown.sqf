...
if (vehicle _unit! = _unit) exitWith {indian "You're already sitting here !!" };
if (_unit distance _chair> 4) exitWith {indian "I hope your feet aren't that long?" };
...
_dir = switch (typeOf _chair) do
{
	...
	case "Land_ScriptOase_Chairs": { 180 };
...
_action = _unit addAction ["<t color='#B45F04'>Otur</t>","scripts\standup.sqf"];
