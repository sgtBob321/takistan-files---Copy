...
/* Logging and Security Settings*/
	...
	vehicle_insurance_multiplier_CIVILIAN = .1; //Civilian Vehicle Insurance Price = Vehicle Buy Price * multiplier 
...
/* Database Related Settings */
    ...
    save_vehicle_items[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit", "cprKit" };
...
/* System Settings */
    ...
    sendtoJail_locations[] = { "Correctional_Facility", "jail_marker" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    jail_forceWalk = true;
    ...
    vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F", "B_G_Offroad_01_armed_F", "B_Boat_Armed_01_minigun_F", "ivory_wrx_marked", "ivory_evox_marked", "ivory_isf_marked", "ivory_m3_marked", "ivory_rs4_marked", "ivory_rs4_unmarked", "tw_raptor_border_patrol", "tw_explorer_border_patrol", "tw_van_border_patrol", "Ch49_rnoaf_330sq", "C_Heli_Light_01_civil_F" }; //Vehicles that can only be rented and not purchased. (Last only for the session)
