...
(_display displayCtrl 1002) ctrlSetStructuredText (parseText (format ["<t align = 'center' shadow = '1' color='#000000' font='PuristaBold'>%1</t>",[life_atmbank] call life_fnc_numberText]));
(_display displayCtrl 1001) ctrlSetStructuredText (parseText (format ["<t align = 'center' shadow = '1' color='#000000' font='PuristaBold'>%1</t>",[life_cash] call life_fnc_numberText]));
