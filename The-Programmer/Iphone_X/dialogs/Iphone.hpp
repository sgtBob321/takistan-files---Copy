...
class The_Programmer_Iphone_Home_Menu {
   ...
   class controls
   {
       ...
       class ButtonMyGang : Life_RscButtonInvisible
       {
           idc = 2011;
           text = "";
		   onButtonClick = "0 call life_fnc_gang_openDialog";
       ...
       {
           idc = 2803;
           tooltip = "Repair Object";
           text = "The-Programmer\Iphone_X\textures\icons\help.paa";
           x = 0.744 * safezoneW + safezoneX;
           y = 0.581 * safezoneH + safezoneY;
           w = 0.04 * safezoneW;
           h = 0.067 * safezoneH;
       ...
       class bourse : Life_RscPicture
       {
           ...
           text = "The-Programmer\Iphone_X\textures\icons\cone.paa";
           x = 0.744 * safezoneW + safezoneX;
           y = 0.438 * safezoneH + safezoneY;
           w = 0.04 * safezoneW;
           h = 0.067 * safezoneH;
